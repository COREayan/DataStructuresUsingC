/*
	1. Write a program to create a graph of n vertices using an adjacency list. Also write the code to read and print its information and finally to delete this graph.
*/
#include <stdio.h>
#include <conio.h>
#include <malloc.h>
